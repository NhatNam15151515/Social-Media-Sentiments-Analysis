...
# Khai báo 3 mảng sentiment như đã phân loại
positive = [
...
# Sử dụng hàm
# Thay 'input.csv' bằng đường dẫn đến file CSV của bạn
# Thay 'output.csv' bằng đường dẫn đến file CSV đầu ra mong muốn
input_file = '../data/external/sentimentdataset.csv'
output_file = '../data/external/sentimentgroups.csv'
